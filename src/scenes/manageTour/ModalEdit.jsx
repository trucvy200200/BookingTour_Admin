...
export default function FormDialog({ open, handleClose, getAllTours, detail }) {
    ...
    const onSubmit = e => {
        if (isObjEmpty(errors)) {
            ...
            axios.post("/api/update-tour-by-id", data, configHeader)
                .then(res => {
                ...
                <Form autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <DialogContent sx={{ backgroundColor: `${colors.primary[400]} !important` }}>
                        <Box
                            ...
                            <FormControl fullWidth sx={{ gridColumn: "span 4", mb: 2 }}>
                                <Controller
                                    name='description'
                                    control={control}
                                    rules={{ required: true }}
                        ...
                        <div>
                            <FileUploaderMultiple setImagesUpload={setFiles} setErrorImage={setErrorImage} imagesUpload={files} errorImage={errorImage} />
                        </div>
                    </DialogContent>
